...
require('lazy').setup({
  ...
  --
  {
    ...
    config = function()
      ...
      vim.g.uniform_diff_background = true
      ...
      vim.keymap.set('n', '<leader>bg', toggle_transparency, { desc = 'Toggle [B]ack[G]round transparency' })
    end,
  },
  {
    ...
    keys = {
      ...
      { '<S-e>', "<cmd>lua require('harpoon.ui').toggle_quick_menu()<cr>", desc = 'Show harpoon marks' },
    },
  },
